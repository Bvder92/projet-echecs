...
{
    int_fast8_t nb_pieces = compter_pieces(couleur, plateau); // nombre de pieces de "couleur" présentes sur l'echequier
    int_fast8_t i, j = 0;
...
{
    int_fast8_t i, j = 0;
    int_fast8_t nb_pieces = compter_pieces(couleur, plateau);
